            ...
            <Flex direction="column">
                ...
                <Flex gap={4} mt={10} direction={{base: 'column', md: 'initial'}}>
                    <Flex p={5} direction={'column'} w={{base: 'auto', md: '356px'}} h={{base: 'auto', md: '144px'}} flexShrink={0} borderRadius={'7.709px'} border={'0.771px solid var(--2, #5BB3EB)'} bg={'rgba(31, 31, 31, 0.15)'} backdropFilter={'blur(7.169522285461426px)'}>
                        <Text color="var(--White, #FFF)" fontSize={{base: '20px', md: '20.77px'}} fontStyle={'normal'} fontWeight={400} sx={{ 'text-edge': 'cap', 'leading-trim': 'both' }} textTransform={'uppercase'} letterSpacing={'0.831px'}>
                            Amount invested
                        </Text>
                        <Text color="var(--White, #FFF)" fontSize={{base: '20px', md: '46.052px'}} fontStyle={'normal'} fontWeight={500} sx={{ 'text-edge': 'cap', 'leading-trim': 'both' }} textTransform={'uppercase'} letterSpacing={'1.842px'}>
                            $2040.00
                        </Text>
                    </Flex>
                    <Flex p={5} direction={'column'} w={{base: 'auto', md: '356px'}} h={{base: 'auto', md: '144px'}} flexShrink={0} borderRadius={'7.709px'} border={'0.771px solid var(--2, #D467E2)'} bg={'rgba(31, 31, 31, 0.15)'} backdropFilter={'blur(7.169522285461426px)'}>
                        ...
                        <Flex mt={{base: 0, md: -2}} align={'center'}>
                            <Text color="#0FEC9C" fontSize={{base: '10px', md: '11.339px'}} fontStyle={'normal'} fontWeight={500} textTransform={'uppercase'} letterSpacing={'0.454px'}>+10%</Text>
            ...
            <Flex mt={10} direction={'column'}>
                ...
                <Flex gap={{base: 5, md: 0}} direction={{base: 'column', md: 'initial'}} p={4} align={{base: 'normal', md: 'center'}} mt={3} justify={{base: 'normal', md: 'space-between'}} backdropFilter={'blur(8.800000190734863px)'} bg={'linear-gradient(118deg, rgba(13, 197, 255, 0.16) -47.79%, rgba(255, 255, 255, 0.07) 100%)'} borderTop={'1px solid rgba(255, 255, 255, 0.08)'} borderRadius={'10px'}  h={{base: 'auto', md: '103px'}} flexShrink={0}>
                    <Flex gap={5} direction={{base: 'column', md: 'initial'}}>
                        ...
                        <Flex direction={'column'}>
                            <Text color="var(--White, #FFF)" fontSize={{base: '20px', md: '24px'}} fontStyle={'normal'} fontWeight={400} >
                                Name of the project
                            </Text>
                            <Text color="var(--White, #FFF)" fontSize={{base: '10px', md: '14px'}} fontStyle={'normal'} fontWeight={300}>
